...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    /**
     * Initialize type edit block
     *
     * @return void
     */
    protected function _construct()
    {
        $this->_objectId = 'id_type';
    ...
    {
        if ($this->_coreRegistry->registry('layout_types_form_data')->getId()) {
            return __("Edit Type '%1'", $this->escapeHtml($this->_coreRegistry->registry('layout_types_form_data')->getTitle()));
        } else {
            return __('New Type');
        }
    }
